...
for size in "${sizes[@]}"; do
    ...
    for alpha in "${alphas[@]}"; do
        ...
        for seed in "${seeds[@]}"; do
            ...
            name=${dataset}_${alpha}_M${size}_${seed}_edim${encode_dim}_server_model_train
            ...
            $env_python $root_dir/Baselines/CoPur/train_server_model.py \
                --size $size \
                --dataset $dataset \
                --datapath $datapath \
                --modelpath $modelpath \
